...
<!--Formulary, URL request_______________________________________-->
    ...
    <main>
        ...
        <form action=" <?php $_SERVER['PHP_SELF'] ?>" method="POST">
            <input type="text" name="video_url" placeholder="Insert your video URL here" autocomplete="off">
...
<!--_____________________Body and info_______________________-->
    ...
    if($isVideoIdValid=="0"){ ?>
        <div class="information_div_box">
            <h3>Sorry, we couldn't find your video, check if the URL is correct.</h3>
        </div>
        <?php }else if($isvalid==""){ ?>
        ...
        <div class="information_div_box">
            ...
            <a href="https://github.com/FelBenini/video_downloader"><h3>Github code</h3></a>
        </div>
